...
import { importJsonFile, wait } from '../../common/general-utils.js';
import { env } from '../../env-and-config/env.js';
import { backendDir } from '../../root.js';
import type { User, Users } from './shared-variables.js';
...
(async function main() {
  ...
  let jsonData: Users = await importJsonFile(`${analyticsDirInSrc}/user-data.json`);
