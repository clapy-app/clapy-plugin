...
import { Dict, TextNodeNoMethod } from '../../sb-serialize-preview/sb-serialize.model';
import { CodeContext } from '../code.model';
import { addStyle } from '../css-gen/css-factories-high';
import { figmaColorToCssRGBA, warnNode } from './_utils-and-reset';

export function colorFigmaToCode(context: CodeContext, node: TextNodeNoMethod, stylesMap: Dict<DeclarationPlain>) {
